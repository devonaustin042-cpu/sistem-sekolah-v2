...
@section('content')
    <x-page-header :title="$schoolClass['name'] ?? 'XII AKL 1'" subtitle="Lembar Kelas" :description="'Jurusan ' . ($schoolClass['major'] ?? 'AKL')" :backUrl="route('SchoolClass.index')" backText="Buku Induk">
        <x-slot:action>
            <a href="{{ route('SchoolClass.edit', $schoolClass['id'] ?? 1) }}"
